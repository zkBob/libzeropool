...
use fawkes_crypto::{rand::thread_rng, backend::bellman_groth16::{Parameters, engines::Bn256, prover, verifier}, engines::bn256::Fr};
...
fn load_params_and_prove() {
    ...
    let (public, secret) = random_sample_delegated_deposit(&mut rng, &*POOL_PARAMS);
